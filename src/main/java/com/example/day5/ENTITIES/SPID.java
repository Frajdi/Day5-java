...
public class SPID extends Base {
    ...
    public SPID(long id, Timestamp created_at, Timestamp created_by, long spidId, USER user, String description) {
        ...
        this.status = com.example.day5.ENTITIES.status.PENDING;
    }
    ...
    public com.example.day5.ENTITIES.status getStatus() {
        return status;
    }
    public void setStatus(com.example.day5.ENTITIES.status status) {
        this.status = status;
    }
